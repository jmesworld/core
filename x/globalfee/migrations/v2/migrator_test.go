...
import (
	...
	v2 "github.com/jmesworld/core/v17/x/globalfee/migrations/v2"
	"github.com/jmesworld/core/v17/x/globalfee/types"
)
...
func TestMigrateMainnet(t *testing.T) {
	...
	params := types.Params{
		MinimumGasPrices: sdk.DecCoins{
			...
			sdk.NewDecCoinFromDec("ujmes", sdk.NewDecWithPrec(75, 3)),
		},
	}

	require.NoError(t, v2.Migrate(ctx, store, cdc, "ujmes"))
...
func TestMigrateTestnet(t *testing.T) {
	...
	params := types.Params{
		MinimumGasPrices: sdk.DecCoins{
			...
			sdk.NewDecCoinFromDec("ujmesx", sdk.NewDecWithPrec(25, 4)),
		},
	}

	require.NoError(t, v2.Migrate(ctx, store, cdc, "ujmesx"))
