...
import (
	...
	drip "github.com/jmesworld/core/v17/x/drip"
	"github.com/jmesworld/core/v17/x/drip/types"
)
	...
	testCases := []struct {
		...
		},
		{
			...
			types.GenesisState{
				Params: types.Params{
					EnableDrip:       true,
					AllowedAddresses: []string{"jmes1v6vlpuqlhhpwujvaqs4pe5dmljapdev4s827ql"},
				},
			},
			false,
		},
		{
			...
			types.GenesisState{
				Params: types.Params{
					EnableDrip:       true,
					AllowedAddresses: []string{"jmes1v6vlpuqlhhpwujvaqs4pe5dmljapdev4s827ql", "jmes1hq2p69p4kmwndxlss7dqk0sr5pe5mmcpf7wqec"},
				},
			},
			false,
		},
		{
			...
			types.GenesisState{
				Params: types.Params{
					EnableDrip:       true,
					AllowedAddresses: []string{"jmes1v6vllollollollollolloldmljapdev4s827ql"},
				},
			},
			true,
		},
