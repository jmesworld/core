...
$BINARY genesis add-genesis-account $VAL1_ADDR 1000000000000ujmes --home $CHAIN_DIR/$CHAINID_1
$BINARY genesis add-genesis-account $VAL2_ADDR 1000000000000ujmes --home $CHAIN_DIR/$CHAINID_2
$BINARY genesis add-genesis-account $WALLET1_ADDR 1000000000000ujmes --home $CHAIN_DIR/$CHAINID_1
$BINARY genesis add-genesis-account $WALLET2_ADDR 1000000000000ujmes --home $CHAIN_DIR/$CHAINID_2
$BINARY genesis add-genesis-account $WALLET3_ADDR 1000000000000ujmes --vesting-amount 10000000000ujmes --vesting-start-time $(date +%s) --vesting-end-time $(($(date '+%s') + 100000023)) --home $CHAIN_DIR/$CHAINID_1
$BINARY genesis add-genesis-account $WALLET4_ADDR 1000000000000ujmes --vesting-amount 10000000000ujmes --vesting-start-time $(date +%s) --vesting-end-time $(($(date '+%s') + 100000023)) --home $CHAIN_DIR/$CHAINID_2
$BINARY genesis add-genesis-account $RLY1_ADDR 1000000000000ujmes --home $CHAIN_DIR/$CHAINID_1
$BINARY genesis add-genesis-account $RLY2_ADDR 1000000000000ujmes --home $CHAIN_DIR/$CHAINID_2

echo "Creating and collecting gentx..."
$BINARY genesis gentx val1 7000000000ujmes --home $CHAIN_DIR/$CHAINID_1 --chain-id $CHAINID_1 --keyring-backend test
$BINARY genesis gentx val2 7000000000ujmes --home $CHAIN_DIR/$CHAINID_2 --chain-id $CHAINID_2 --keyring-backend test
