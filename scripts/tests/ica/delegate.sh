...
$BINARY tx bank send $WALLET_2 $ICS_TX_RESULT 10000000ujmes --chain-id test-2 --home $CHAIN_DIR/test-2 --node tcp://localhost:26657 --keyring-backend test -y &> /dev/null
sleep 5
