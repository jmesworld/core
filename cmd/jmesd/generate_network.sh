...
yes "boost top desk keen unusual scene entire belt cargo protect subject donor front dose narrow fruit square despair chat crush visual reform river decorate" | ./jmesd keys add devnode --recover || ./jmesd init --chain-id=jmes-888 devnode && ./jmesd add-genesis-account jmes1wrrjk4xurqk2ukaxr4hlrmsfgprxm075gnwacn 0ujmes && yes "boost top desk keen unusual scene entire belt cargo protect subject donor front dose narrow fruit square despair chat crush visual reform river decorate" | ./jmesd gentx devnode 0ujmes --chain-id=jmes-888 && ./jmesd collect-gentxs
#
#- name: wallet
#  type: local
