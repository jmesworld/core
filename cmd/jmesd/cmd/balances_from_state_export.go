...
// https://github.com/jmesworld/core/v17/blob/main/cmd/osmosisd/cmd/balances_from_state_export.go
...
Example:
	jmesd export-derive-balances ../genesis.json ../snapshot.json
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Produce the map of address to total jmes balance, both staked and UnbondingStake
...
Example:
	jmesd staked-to-csv ../balances.json ../airdrop.csv
`,
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx := client.GetClientContextFromCmd(cmd)
