...
func runConfigCmd(cmd *cobra.Command, args []string) error {
	...
	jcc := JmesCustomClient{
		*conf,
		os.Getenv("JMESD_GAS"),
		os.Getenv("JMESD_GAS_PRICES"),
		os.Getenv("JMESD_GAS_ADJUSTMENT"),

		os.Getenv("JMESD_FEES"),
		os.Getenv("JMESD_FEE_GRANTER"),
		os.Getenv("JMESD_FEE_PAYER"),

		os.Getenv("JMESD_NOTE"),
	}
...
###############################################################################
###                          Jmes Tx Configuration                          ###
###############################################################################

# Amount of gas per transaction
gas = "{{ .Gas }}"
# Price per unit of gas (ex: 0.005ujmes)
...
// configFilePath.
func writeConfigToFile(configFilePath string, config *JmesCustomClient) error {
