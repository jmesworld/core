...
import (
	...
	"github.com/jmesworld/core/v17/app/params"
)
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		Use:   version.AppName,
		Short: "Jmes Smart Contract Zone",
...
func initAppConfig() (string, interface{}) {
	...
	// srvCfg.MinGasPrices = "0ujmes,0ujmesx" // GlobalFee handles
...
func SetCustomEnvVariablesFromClientToml(ctx client.Context) {
	...
	// gas
	setEnvFromConfig("gas", "JMESD_GAS")
	setEnvFromConfig("gas-prices", "JMESD_GAS_PRICES")
	setEnvFromConfig("gas-adjustment", "JMESD_GAS_ADJUSTMENT")
	// fees
	setEnvFromConfig("fees", "JMESD_FEES")
	setEnvFromConfig("fee-account", "JMESD_FEE_ACCOUNT")
	// memo
	setEnvFromConfig("note", "JMESD_NOTE")
}
