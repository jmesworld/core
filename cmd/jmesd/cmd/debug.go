...
// get cmd to convert any bech32 address to a jmes prefix.
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "bech32-convert [bech32 string]",
		Short: "Convert any bech32 string to the jmes prefix",
		Long: `Convert any bech32 string to the jmes prefix
Especially useful for converting cosmos addresses to jmes addresses
Example:
	jmesd bech32-convert jmes1ey69r37gfxvxg62sh4r0ktpuc46pzjrm5cxnjg -p osmo
	`,
	...
	cmd.Flags().StringP(flagBech32Prefix, "p", "jmes", "Bech32 Prefix to encode to")
