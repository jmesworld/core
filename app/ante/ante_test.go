...
func createTestApp(isCheckTx bool, tempDir string) (*jmesapp.JmesApp, sdk.Context) {
	app := jmesapp.NewJmesApp(
		log.NewNopLogger(), dbm.NewMemDB(), nil, true, map[int64]bool{},
		tempDir, simapp.FlagPeriodValue, jmesapp.MakeEncodingConfig(),
