...
import (
	...
	dripkeeper "github.com/jmesworld/core/v17/x/drip/keeper"
	driptypes "github.com/jmesworld/core/v17/x/drip/types"
	feesharekeeper "github.com/jmesworld/core/v17/x/feeshare/keeper"
	feesharetypes "github.com/jmesworld/core/v17/x/feeshare/types"
	"github.com/jmesworld/core/v17/x/globalfee"
	globalfeekeeper "github.com/jmesworld/core/v17/x/globalfee/keeper"
	globalfeetypes "github.com/jmesworld/core/v17/x/globalfee/types"
	mintkeeper "github.com/jmesworld/core/v17/x/mint/keeper"
	minttypes "github.com/jmesworld/core/v17/x/mint/types"
	"github.com/jmesworld/core/v17/x/tokenfactory/bindings"
...
func NewAppKeepers(
	...
	jmesPrefix := sdk.GetConfig().GetBech32AccountAddrPrefix()
	wasmHooks := ibc_hooks.NewWasmHooks(appKeepers.IBCHooksKeeper, &appKeepers.WasmKeeper, jmesPrefix) // The contract keeper needs to be set later
