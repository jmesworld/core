...
import (
	...
	jmes_app "github.com/jmesworld/core/v2/app"
)
...
func TestSimAppExportAndBlockedAddrs(t *testing.T) {
	encCfg := jmes_app.MakeEncodingConfig()
	db := dbm.NewMemDB()
	app := jmes_app.NewJMESApp(
		log.NewTMLogger(log.NewSyncWriter(os.Stdout)),
		db, nil, true, map[int64]bool{}, jmes_app.DefaultNodeHome, 0, encCfg,
	...
	app2 := jmes_app.NewJMESApp(
		log.NewTMLogger(log.NewSyncWriter(os.Stdout)),
		db, nil, true, map[int64]bool{}, jmes_app.DefaultNodeHome, 0,
...
func TestInitGenesisOnMigration(t *testing.T) {
	...
	app := jmes_app.NewJMESApp(
		...
		jmes_app.DefaultNodeHome, 0, encCfg, simtestutil.EmptyAppOptions{}, wasmconfig.DefaultConfig())
