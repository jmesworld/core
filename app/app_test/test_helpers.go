...
import (
	...
	terrraParams "github.com/jmesworld/core/v2/app/params"
...
func (s *AppTestSuite) Setup() {
	...
	db := dbm.NewMemDB()
	s.App = jmes_app.NewJMESApp(
		log.NewTMLogger(log.NewSyncWriter(os.Stdout)),
		db,
		nil,
		true,
		map[int64]bool{},
		jmes_app.DefaultNodeHome,
		0,
		encCfg,
...
func SetupGenesisValSet(
	...
	genesisState := jmes_app.NewDefaultGenesisState(encCfg.Marshaler)
