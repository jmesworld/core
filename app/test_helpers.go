...
import (
	...
	apphelpers "github.com/jmesworld/core/v17/app/helpers"
	appparams "github.com/jmesworld/core/v17/app/params"
)
...
// SetupWithGenesisValSet initializes a new jmesApp with a validator set and genesis accounts
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *App {
	...
	jmesApp, genesisState := setup(t, true)
	genesisState = genesisStateWithValSet(t, jmesApp, genesisState, valSet, genAccs, balances...)
	...
	jmesApp.Commit()
	jmesApp.BeginBlock(abci.RequestBeginBlock{Header: tmproto.Header{
		ChainID:            "testing",
		Height:             jmesApp.LastBlockHeight() + 1,
		AppHash:            jmesApp.LastCommitID().Hash,
